...
var WishlistModel = /** @class */ (function () {
    function WishlistModel() {
    }
    WishlistModel.prototype.get = function () {
    ...
    WishlistModel.prototype.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    //where
    WishlistModel.prototype.where = function (string) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM wishlist WHERE ".concat(string);
                        return [4 /*yield*/, database_1.default.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    WishlistModel.prototype.store = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, record, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO wishlist (user_id, product_id) VALUES($1, $2) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
    ...
    WishlistModel.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, wishlist, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
