...
var productModel = /** @class */ (function () {
    ...
    productModel.prototype.get = function () {
    ...
    //where
    productModel.prototype.where = function (string) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM products WHERE ".concat(string);
                        return [4 /*yield*/, database_1.default.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    productModel.prototype.store = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new product. Error: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    productModel.prototype.update = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "UPDATE products SET \n      title ='".concat(request.title, "',\n      description ='").concat(request.description, "' ,\n      stock = ").concat(request.stock, ",\n      price = ").concat(request.price, ",\n      sale_price = ").concat(request.sale_price, ",\n      category_id = ").concat(request.category_id, "\n      WHERE id =").concat(request.id);
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql)];
    ...
    //delete product
    productModel.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
