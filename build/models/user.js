...
var UserModel = /** @class */ (function () {
    ...
    //where
    UserModel.prototype.where = function (string) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM users WHERE ".concat(string);
                        return [4 /*yield*/, database_1.default.query(sql)];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    UserModel.prototype.store = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO users (name, email ,phone  , country_id , city_id ,  password , created_at) VALUES($1, $2, $3 , $4 , $5 , $6 , $7 ) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new user ".concat(request.name, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserModel.prototype.update = function (request) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // delete user
    UserModel.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
