...
var CategoryHandler = /** @class */ (function () {
    ...
    CategoryHandler.prototype.details = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, cat, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        sql = "SELECT categories.name as category_name , products.* \n      FROM products\n      INNER JOIN categories ON products.category_id = products.id WHERE category_id =$1";
                    ...
                    case 2:
                        result = _a.sent();
                        return [4 /*yield*/, conn.query('SELECT id , name FROM categories WHERE id =$1', [id])];
                    case 3:
                        cat = _a.sent();
                        conn.release();
                        return [2 /*return*/, {
