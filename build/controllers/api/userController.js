    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                faq = _a.sent();
                if (faq) {
                    res.status(200).json((0, responses_1.sendResponse)(faq, 'User Profile'));
                    return [2 /*return*/];
                }
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var record, hash, data, result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 2:
                result = _a.sent();
                res.json((0, responses_1.sendResponse)(result, 'Your profile Has Been Updated Successfully'));
                return [3 /*break*/, 4];
            case 3:
