...
var category_2 = require("../../handlers/category");
var model = new category_1.CategoryModel();
var handler = new category_2.CategoryHandler();
...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                categories = _a.sent();
                res.status(200).json((0, responses_1.sendResponse)(categories, 'get all categories'));
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                res.status(200).json((0, responses_1.sendResponse)(category, 'category details'));
                return [2 /*return*/];
            case 3:
