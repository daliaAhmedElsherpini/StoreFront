...
var model = new review_1.ReviewModel();
...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, model.where("product_id = ".concat(req.params.id))];
            case 1:
                product = _a.sent();
                if (product) {
                    res.status(200).json((0, responses_1.sendResponse)(product, 'all product reviews'));
                    return [2 /*return*/];
                }
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                new_review = _a.sent();
                res.json((0, responses_1.sendResponse)(new_review, 'Your Review Has Been Send Successfully'));
                return [3 /*break*/, 4];
            case 3:
                err_2 = _a.sent();
                res.status(400);
