...
var appInfo_1 = require("../models/appInfo");
var request = (0, supertest_1.default)(index_1.default);
var model = new appInfo_1.AppInfoModel();
describe('Test Application Information ', function () {
    describe('Test Application Information endpoint responses ', function () {
        it('get all information about the application', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/api/appinfo')];
                    case 1:
                        response = _a.sent();
    ...
    describe('Test AppInfo Model Methods ', function () {
