...
var faq_1 = require("../models/faq");
var model = new faq_1.FaqModel();
var request = (0, supertest_1.default)(index_1.default);
describe("Test FAQ's responses ", function () {
    describe("Test FAQ's endpoint responses ", function () {
        it('check get all FAQS about the application', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/api/faqs')];
                    case 1:
                        response = _a.sent();
        ...
        // check with valid id
        it('check get details of the FAQ with its id', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('check get details of the FAQ with wrong id', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/api/faqs/1000')];
                    case 1:
                        response = _a.sent();
    ...
    describe("Test FAQ's Model Methods ", function () {
