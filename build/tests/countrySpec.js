...
var model = new country_1.CountryModel();
describe('Test Countries responses ', function () {
    describe('Test Countries endpoint responses ', function () {
        it('get all Countries the application', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/api/countries')];
                    case 1:
                        response = _a.sent();
    ...
    describe('Test Countries Model Methods ', function () {
