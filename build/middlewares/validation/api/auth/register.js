...
var registerValidation = [
    ...
    check('email')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, model.where("email = '".concat(email, "'"))];
                case 1:
    ...
    check('phone')
        ...
        .custom(function (phone) { return __awaiter(void 0, void 0, void 0, function () {
        var existingUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, model.where("phone = '".concat(phone, "'"))];
                case 1:
                    existingUser = _a.sent();
                    if (existingUser.length) {
