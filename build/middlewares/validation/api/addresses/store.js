...
var addressValidation = [
    check('country_id')
        ...
        .custom(function (country_id) { return __awaiter(void 0, void 0, void 0, function () {
        var existingCountry;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, countrymodel.find(country_id)];
                case 1:
    ...
    check('city_id')
        ...
        .custom(function (city_id) { return __awaiter(void 0, void 0, void 0, function () {
        var existingCity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, citymodel.find(city_id)];
                case 1:
