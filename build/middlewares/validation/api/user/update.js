...
var updateUserValidation = [
    ...
    check('email')
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, model.where("email = '".concat(email, "' AND id != ").concat(req.params.id))];
                    case 1:
    ...
    check('phone')
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, model.where("phone = '".concat(phone, "' AND id != ").concat(req.params.id))];
                    case 1:
                        existingUser = _b.sent();
                        if (existingUser.length) {
